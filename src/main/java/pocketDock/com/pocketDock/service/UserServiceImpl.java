...
public class UserServiceImpl implements UserService {
    ...
    public OurUsers findByIdAndRole(Integer userId, String role) {
        // Implémentez la logique pour récupérer un utilisateur par son ID et son rôle
        return ourUserRepo.findByIdAndRole(userId, role);
    }
    public List<OurUsers> searchDoctorsByCountryOrCity(String country, String city) {
        return ourUserRepo.findByCountryOrCityAndRoleDoctor(country, city);
    }
